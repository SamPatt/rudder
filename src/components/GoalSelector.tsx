...
export default function GoalSelector({ 
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[9999] p-4">
      <div className="bg-slate-800 rounded-lg shadow-xl max-w-4xl w-full max-h-[80vh] overflow-hidden border border-slate-700">
        {/* Header */}
        <div className="p-6 border-b border-slate-700">
          ...
          <input
            ...
            className="w-full px-4 py-2 border border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-forest-500 bg-slate-700 text-slate-200"
            autoFocus
          />
              ...
              {filteredGoalsByValue.map(({ value, goals: valueGoals }) => (
                <div key={value.id} className="space-y-3">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <h3 className="text-lg font-medium text-slate-200">{value.name}</h3>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                    {valueGoals.map(goal => (
                      <button
                        ...
                        className={`p-4 border rounded-lg transition-colors text-left group bg-slate-700 ${
                        ...
                        <div className="flex items-start space-x-3">
                          {multiple && (
                            <input
                              ...
                              readOnly
                              className="h-4 w-4 text-forest-600 focus:ring-forest-500 border-slate-500 rounded bg-slate-600 mt-1"
                            />
                          )}
        ...
        <div className="p-6 border-t border-slate-700 bg-slate-800">
          <div className="flex space-x-3">
            <button
              ...
              className="flex-1 py-3 px-4 border border-slate-600 rounded-lg hover:bg-slate-700 transition-colors text-slate-300 font-medium"
            >
              No Goal
            </button>
            {multiple && (
              <button
                ...
                className="flex-1 py-3 px-4 bg-forest-600 text-white rounded-lg hover:bg-forest-700 transition-colors font-medium"
              >
